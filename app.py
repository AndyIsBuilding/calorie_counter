...
def get_testimonials():
    testimonials = [
        {
            "quote": "AppStack has made it so easy for me to keep on top of my nutrition. I've never felt better!",
            "author": "Sarah L.",
            "role": "Fitness Enthusiast",
        },
        {
            "quote": "As a nutritionist, I recommend AppStack to all my clients. It's user-friendly and accurate.",
